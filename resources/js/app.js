...
// Subscribe to the user-to-admin channel if userId is defined
if (typeof userId !== 'undefined' && userId !== null) {
    window.Echo.private('user-to-admin.' + userId)
        .listen('UserMessageSent', (event) => {
            console.log('New message received from user:', event);

            // Append the new message to the chat UI dynamically (adjust this logic to match your UI)
            appendMessageToChat(event.sender_id, {
