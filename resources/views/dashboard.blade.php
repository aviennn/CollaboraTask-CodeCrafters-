...
<x-slot name="header">
    ...
    <!-- Left Section: Dashboard Title and Session Duration -->
    <div>
    ...
    <!-- Right Section: Feature Modal Icon -->
    <p class="text-lg font-semibold text-gray-500 mt-2">
        <a href="#" data-toggle="modal" data-target="#featureModal" title="Core Features" style="text-decoration: none;">
            <i class="fas fa-info-circle text-primary cursor-pointer"
               style="font-size: 2em; animation: float 2s ease-in-out infinite; color: #1D4ED8;"></i>
        </a>
    </p>
</div>
...
<!-- Include the feature modal -->
@include('components.feature-modal')
...
<div class="row mb-3">
    ...
    <div class="col-12 col-md-auto mb-2 mb-md-0">
        <button id="add-note-widget" class="btn btn-primary w-100">Add Note Widget</button>
    </div>
    <div class="col-12 col-md-auto mb-2 mb-md-0">
        <button id="show-matrix-modal" class="btn btn-primary w-100" data-toggle="modal" data-target="#eisenhowerMatrixModal">
            View Eisenhower Matrix
        </button>
    </div>
    <div class="col-12 col-md-auto">
        <button id="add-checklist-widget" class="btn btn-primary w-100">Add Checklist Widget</button>
    </div>
</div>
...
<div class="row">
    <!-- Teams Box -->
    <div class="col-12 col-sm-6 col-md-4 d-flex align-items-center sortable-item">
        <a href="{{ route('user.teams.index') }}" class="text-decoration-none w-100">
            <div class="info-box mb-3 shadow">
                <span class="info-box-icon bg-danger"><i class="fas fa-users"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text">Teams You Belong To</span>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <i class="fas fa-users"></i> {{ $userTeamsCount }}
                    </div>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('user.tasks.filter', 'all') }}" class="text-decoration-none w-100">
            <div class="info-box mb-3 shadow">
                ...
                <div class="info-box-content">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="h5 mb-0 font-weight-bold">{{ $taskStatusCounts['all'] }}</span>
                        <span class="text-xs text-gray-800 ml-2">All</span>
                    </div>
                </div>
            </div>
        </a>
...
<div class="col-12 col-sm-6 col-md-4 d-flex align-items-center sortable-item">
    <a href="{{ route('invitations.index') }}" class="text-decoration-none w-100">
        <div class="info-box mb-3 shadow">
            <span class="info-box-icon bg-warning"><i class="fas fa-envelope"></i></span>
            <div class="info-box-content">
                <span class="info-box-text">Pending Invitations</span>
                <div class="d-flex align-items-center">
                    <span class="h5 mb-0 font-weight-bold">{{ $pendingInvitationsCount }}</span>
                    <span class="text-xs text-gray-800 ml-2">Pending</span>
                </div>
            </div>
        </div>
    </a>
        ...
        <div class="card-body d-flex flex-column">
            ...
            <div class="task-list flex-grow-1">
                ...
                @foreach($userTeams as $team)
                    @php
                        // Filter tasks for this team where the current user is assigned
                        $teamTasks = $recentTeamTasks->filter(function($task) use ($team, $user) {
                            return $task->team_id == $team->id && $task->assignments->contains('id', $user->id);
                        });
                    @endphp
