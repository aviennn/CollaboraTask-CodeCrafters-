...
.hero {
    ...
    align-items: center;
    min-height: 70vh;
    background: linear-gradient(70deg, #0b387e, #050505);
    text-align: center;
    padding: 3.4rem;
...
.header {
    ...
    width: calc(100% - 2rem); /* Dynamic width adjustment */
...
@media (min-width: 768px) {
    .header {
        width: calc(100% - 4rem); /* Adjust width for larger screens */
        border-radius: 20px;
    }
}
...
@media (min-width: 1024px) {
    .header {
        width: calc(100% - 5rem); /* Adjust width for desktops */
        border-radius: 30px;
    }
}
...
@media (min-width: 1440px) {
    .header {
        width: calc(100% - 6rem); /* Adjust width for large desktops */
        border-radius: 50px;
    }
}
...
.register-box {
    ...
    border: 1px solid transparent;
    color: #000 !important;
    background: linear-gradient(163deg, #1c6dd1, #85f1ff);
    border-radius: 27px;
    background-clip: padding-box;
    text-decoration: none;
        ...
        function changeImage(icon) {
            ...
            switch (icon) {
                ...
                case 'list':
                    ...
                    break;
                case 'calendar':
                    image.src = '/dist/img/calendard.png';
